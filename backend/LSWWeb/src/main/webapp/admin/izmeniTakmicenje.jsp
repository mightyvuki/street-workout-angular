...
<body>
	...
	<div class="add-box">
        ...
        <h2 class="text-center mb-4">Izmeni takmičenje</h2>
		
		<form:form modelAttribute="takmicenje" action="${pageContext.request.contextPath}/adminController/takmicenja/izmeni" method="post">
		    <form:hidden path="id"/>
		
		    <div class="mb-3">
		        <label class="form-label" for="naziv">Naziv takmičenja:</label>
		        <form:input path="naziv" id="naziv" class="form-control" required="required"/>
		    </div>
		
		    <div class="mb-3">
		        <label class="form-label" for="datum">Datum:</label>
		        <form:input path="datum" id="datum" type="date" class="form-control" required="required"/>
		    </div>
		
		    <div class="mb-3">
		        <label class="form-label" for="lokacija">Lokacija:</label>
		        <form:input path="lokacija" id="lokacija" class="form-control" required="required"/>
		    </div>
